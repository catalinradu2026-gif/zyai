...
export default function ChatWidget() {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-96 bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl flex flex-col h-[500px] z-40 animate-in fade-in slide-in-from-bottom-4 border border-white/30">
          {/* Header */}
