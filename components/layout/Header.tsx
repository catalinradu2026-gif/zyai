    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 ml-auto flex-shrink-0">
          ...
          <Link
            href="/anunt/nou"
            className="flex items-center gap-1.5 px-3 py-2 rounded-lg font-medium whitespace-nowrap transition-all duration-200 transform hover:scale-105 gradient-main text-white text-sm"
