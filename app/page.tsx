...
export default async function Home() {
  ...
  // "Cele mai noi" = toate anunțurile active + licitații, sortate strict după created_at DESC
...
{/* ========== NEW HERO: AI BROKER ========== */}
        <section className="relative mb-12 md:mb-16">
          <div className="relative max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-black mb-3 leading-tight" style={{ color: 'var(--text-primary)' }}>
              <span className="gradient-main-text">AI Broker</span> pentru Auto și Imobiliare
            </h1>
            <p className="text-lg md:text-xl mb-8" style={{ color: 'var(--text-secondary)' }}>
              Verifică, evaluează, vinde — totul cu AI
            </p>
            <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4 mb-4">
              <Link
                href="/anunt/nou"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl glass glass-hover font-semibold transition-transform hover:scale-[1.03]"
            ...
            <p className="text-sm italic" style={{ color: 'var(--text-secondary)' }}>
              „Pune ce ai. AI face restul."
            </p>
          </div>
        </section>

        {/* ========== SECTION 1: CORE PRODUCT (Buyer / Seller) ========== */}
        <section className="max-w-5xl mx-auto mb-12 md:mb-16">
          <div className="grid md:grid-cols-2 gap-5 md:gap-6">
            {/* BUYER AI */}
            <div
              className="relative rounded-3xl p-7 md:p-8 glass glass-hover transition-all duration-300 hover:scale-[1.01]"
              style={{ borderTop: '3px solid #3B82F6' }}
            >
              <div className="flex items-center gap-2 mb-3">
                <span className="text-3xl">🟦</span>
                <h3 className="text-2xl font-black" style={{ color: 'var(--text-primary)' }}>BUYER AI</h3>
              </div>
              <p className="text-lg font-semibold mb-4" style={{ color: 'var(--text-primary)' }}>
                Verifică dacă merită să cumperi
              </p>
              <ul className="space-y-2 mb-6 text-base" style={{ color: 'var(--text-secondary)' }}>
                <li>✓ Scor AI 0-100</li>
                <li>✓ Preț corect?</li>
                <li>✓ Risc scam</li>
              </ul>
              <Link
                href="/buyer"
                className="inline-flex items-center justify-center w-full gap-2 px-6 py-3 rounded-xl font-bold text-white transition-transform hover:scale-[1.02]"
            ...
            >
              <div className="flex items-center gap-2 mb-3">
                <span className="text-3xl">🟧</span>
                <h3 className="text-2xl font-black" style={{ color: 'var(--text-primary)' }}>SELLER AI</h3>
              </div>
              <p className="text-lg font-semibold mb-4" style={{ color: 'var(--text-primary)' }}>
                Creează anunț perfect din poze
              </p>
              <ul className="space-y-2 mb-6 text-base" style={{ color: 'var(--text-secondary)' }}>
                <li>✓ Titlu + descriere</li>
                <li>✓ Preț estimat</li>
                <li>✓ Export ready</li>
              </ul>
              <Link
        ...
        {/* ========== SECTION 2: VIRAL HOOK ========== */}
        <section className="max-w-5xl mx-auto mb-12 md:mb-16">
          <div
            className="relative rounded-3xl p-8 md:p-10 text-center overflow-hidden"
            style={{
              background: 'linear-gradient(135deg, rgba(34,197,94,0.12), rgba(234,179,8,0.10))',
              border: '1px dashed rgba(34,197,94,0.4)',
            }}
          >
            <div className="text-4xl md:text-5xl mb-3">📸</div>
            <h3 className="text-2xl md:text-3xl font-black mb-2" style={{ color: 'var(--text-primary)' }}>
              Vrei să vinzi ORICE din casă?
            </h3>
            <p className="text-base md:text-lg mb-6" style={{ color: 'var(--text-secondary)' }}>
              Fă o poză → AI îți face anunțul instant
            </p>
            <Link
              href="/quick"
              className="inline-flex items-center gap-2 px-7 py-3 rounded-full font-bold text-base text-white transition-transform hover:scale-[1.04]"
              style={{ background: 'linear-gradient(to right,#22C55E,#EAB308)' }}
            >
              Fă o poză acum →
            </Link>
            <p className="text-xs italic mt-4 opacity-80" style={{ color: 'var(--text-secondary)' }}>
              *gratuit, fără cont*
            </p>
          </div>
        </section>

        {/* ========== SECTION 3: Broker AI Premium ========== */}
        <section className="max-w-5xl mx-auto mb-14 md:mb-20">
          <div
            className="rounded-2xl p-6 md:p-7 flex flex-col md:flex-row items-center justify-between gap-4 glass"
            style={{ borderLeft: '3px solid #8B5CF6' }}
          >
            <div className="text-center md:text-left">
              <h4 className="text-xl md:text-2xl font-black mb-1" style={{ color: 'var(--text-primary)' }}>
                🤖 Broker AI — Negociază pentru tine
              </h4>
              <p className="text-sm md:text-base" style={{ color: 'var(--text-secondary)' }}>
                Alternative, recomandări, follow-up
              </p>
            </div>
            <Link
              href="/premium"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-white whitespace-nowrap transition-transform hover:scale-[1.03]"
